-- Импорт orders БЕЗ CSV (10 строк) — выполни в Query Tool базы dwdw
-- users, products, pickup_points уже должны быть загружены

TRUNCATE orders RESTART IDENTITY CASCADE;

INSERT INTO orders (order_id, order_articles, order_date, delivery_date, pickup_point_ref, client_full_name, pickup_code, status_name) VALUES
...
-- проверка
SELECT order_id, pickup_point_ref, delivery_date, status_name FROM orders;
